  ...
  return (
    <div>
      ...
      <p>HydroJed  is a leading hydraulic solutions provider based in Jeddah,
        ...
        <i class="fa-solid fa-location-dot" style={{display: 'inline-block', marginRight: '10px'}}></i><p style={{display: 'inline-block'}}>5119 طريق مكة القديم، District, Madain Al Fahd, جدة 22343</p>
        </a>
        <br></br>
        <i class="fa-regular fa-envelope" style={{ marginRight: '6px'}}></i><p style={{display: 'inline-block'}}>info@hydro-jed.com</p>
        <br></br>
        <i class="fa-solid fa-phone-volume" style={{ marginRight: '6px'}}></i><p style={{display: 'inline-block'}}>+966 50 461 7194</p>
    </div>
  );
};
