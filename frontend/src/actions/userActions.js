...
export const login = (email, password) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/users/login`, {email, password}, config)
...
export const register = (name, email, password) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/users`, {name, email, password}, config)
...
export const deleteUser = (id) => async (dispatch, getState) => {
    try {
        ...
        await axios.delete(`${process.env.REACT_APP_API_BASE_URL}/api/users/${id}`, config)
...
export const editUser = (user) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`${process.env.REACT_APP_API_BASE_URL}/api/users/${user._id}`, user, config)
