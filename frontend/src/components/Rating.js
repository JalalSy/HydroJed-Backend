...
Rating.defaultProps ={
    color: '#f8e825' //stars color
}


Rating.propTypes = {
    value: PropTypes.number,//removed (.isRequired because it was causing an error) "react-jsx-dev-runtime.development.js:87 Warning: Failed prop type: The prop `value` is marked as required in `Rating`, but its value is `undefined`."
